// frame_buffer_alt_vip_cl_vfb_0.v
...
`timescale 1 ps / 1 ps
module frame_buffer_alt_vip_cl_vfb_0 #(
		...
		parameter MAX_WIDTH                    = 160,
		parameter MAX_HEIGHT                   = 120,
		...
		parameter WRITER_RUNTIME_CONTROL       = 1,
		...
		input  wire [11:0]  din_data,                    //           din.data
		...
		output wire [11:0]  dout_data,                   //          dout.data
	...
	wire  [43:0] video_in_av_st_dout_data;              // video_in:av_st_dout_data -> wr_ctrl:vib_data_data
	...
	wire  [43:0] wr_ctrl_pkt_wr_data_data;              // wr_ctrl:pkt_wr_data_data -> pkt_trans_wr:av_st_din_data
	...
	wire  [43:0] rd_ctrl_vob_data_data;                 // rd_ctrl:vob_data_data -> video_out:av_st_din_data
	...
	wire  [43:0] pkt_trans_rd_av_st_dout_data;          // pkt_trans_rd:av_st_dout_data -> rd_ctrl:pkt_rd_data_data
	...
	frame_buffer_alt_vip_cl_vfb_0_video_in video_in (
	...
	alt_vip_vfb_sync_ctrl #(
		...
		.writer_control_address       (control_address),                 // writer_control.address
		.writer_control_byteenable    (control_byteenable),              //               .byteenable
		.writer_control_write         (control_write),                   //               .write
		.writer_control_writedata     (control_writedata),               //               .writedata
		.writer_control_read          (control_read),                    //               .read
		.writer_control_readdata      (control_readdata),                //               .readdata
		.writer_control_readdatavalid (control_readdatavalid),           //               .readdatavalid
		.writer_control_waitrequest   (control_waitrequest)              //               .waitrequest
	);
